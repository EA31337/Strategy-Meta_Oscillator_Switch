...
INPUT3 float Meta_Oscillator_Switch_SignalOpenLevel = 0;        // Signal open level
INPUT3 int Meta_Oscillator_Switch_SignalOpenSwitchMethod = 32;  // Signal open filter method
INPUT3 int Meta_Oscillator_Switch_SignalOpenSwitchTime = 3;     // Signal open filter time (0-31)
INPUT3 int Meta_Oscillator_Switch_SignalOpenBoostMethod = 0;    // Signal open boost method
INPUT3 int Meta_Oscillator_Switch_SignalCloseMethod = 0;        // Signal close method
INPUT3 int Meta_Oscillator_Switch_SignalCloseSwitch = 32;       // Signal close filter (-127-127)
INPUT3 float Meta_Oscillator_Switch_SignalCloseLevel = 0;       // Signal close level
INPUT3 int Meta_Oscillator_Switch_PriceStopMethod = 0;          // Price limit method
INPUT3 float Meta_Oscillator_Switch_PriceStopLevel = 2;         // Price limit level
INPUT3 int Meta_Oscillator_Switch_TickSwitchMethod = 32;        // Tick filter method (0-255)
INPUT3 float Meta_Oscillator_Switch_MaxSpread = 4.0;            // Max spread to trade (in pips)
INPUT3 short Meta_Oscillator_Switch_Shift = 0;                  // Shift
INPUT3 float Meta_Oscillator_Switch_OrderCloseLoss = 200;       // Order close loss
INPUT3 float Meta_Oscillator_Switch_OrderCloseProfit = 200;     // Order close profit
INPUT3 int Meta_Oscillator_Switch_OrderCloseTime = 2880;        // Order close time in mins (>0) or bars (<0)
